...
import classes from "./NseBse.module.css";
    ...
    <>
      ...
      <div className={classes.mainCont}>
        ...
        <div className={classes.section}>
          ...
          <div className={classes.image}>
            <img src="./3.png" alt="nse" />
          </div>
          <p>
            In a bear market, the opposite is true: more people are looking to
            sell than buy. The demand is significantly lower than supply and, as
            a result, share prices drop.
          </p>
          <h2>Investor Psychology-</h2>
          <p>
            Because the market's behavior is impacted and determined by how
            individuals perceive and react to its behavior, investor psychology
            and sentiment affect whether the market will rise or fall. Stock
            market performance and investor psychology are mutually dependent.
            In a bull market, investors willingly participate in the hope of
            obtaining a profit.{" "}
          </p>
          <div className={classes.image}>
            <img src="./4.png" alt="nse" />
          </div>
          <h2>Change in Economic Activity-</h2>
          <p>
            Because the businesses whose stocks are trading on the exchanges are
            participants in the greater economy, the stock market and the
            economy are strongly linked.{" "}
          </p>
          <div className={classes.image}>
            <img src="./5.png" alt="nse" />
          </div>
          <p>
            A bear market is associated with a weak economy. Most businesses are
            unable to record huge profits because consumers are not spending
            nearly enough. This decline in profits directly affects the way the
            market values stocks.
          </p>
        </div>
      </div>
    </>
